...
%konzulens adatai
\renewcommand{\konzulens}{Ács Zoltán}
\renewcommand{\konzbeoszt}{egytemi tanár}

%a dolgozat cime, ev
\renewcommand{\cim}{Többasztalos és -felhasználós póker játék adatbázis modellezése}
\renewcommand{\ev}{2004.}

\begin{document}

\include{01_elozm}      %elso lapok (Cimlap, kiiras, tartalomjegyzek, Kivonat, Abstract,egyeb)
\include{02_eloszo}     %Eloszo, ebben celkituzes, elozmenyek, felepites, koszonetnyilvanitas
                        %max. nehany oldal

\include{03_1fej}       %elso fejezet: bevezetes
\include{04_2fej}       %masodik fejezet: a problema reszletes kifejtese
\include{05_3fej}       %harmadik fejezet: eddig alkalmazott megoldas

\include{06_4fej}       %negyedik fejezet: a jelolt megoldasa
\include{07_5fej}       %Osszefoglalas: ertekeles, tovabbi munka

%\include{08_utozm}     %Utolso lapok: koszonetnyilvanitas, egyeb...

\include{09_irod}       %Irodalomjegyzek

\include{10_f0_cl}      %Fuggelek cimlap
\include{10_f1_or}      %1. fuggelek
...
%\include{10_f7_br}      %Biralat: k?s?bbi k?t?shez, opcionalis

%\include{11_lof}        %Esetleges abrak, tablazatok jegyzeke (lehet az elejen is, nem kotelezo)
\include{12_rovid}      %Roviditesek jegyzeke
